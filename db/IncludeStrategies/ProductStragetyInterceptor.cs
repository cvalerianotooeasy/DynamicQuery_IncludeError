...
{
    public class ProductStragetyInterceptor : IIncludeStrategyInterceptor<Product>
    {
        ...
        public IQueryable<Product> InterceptIncludeStrategy(IQueryCriteria criteria, IQueryable<Product> queryable)
        {
            ...
            //if i add this fields, the library get all fields on AttributeValues With include Attribute and IT Works Great by it get all fields
